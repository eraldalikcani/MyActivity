...
export default class CommentStore {
    ...
    {
        //check if we have any selected activity in our store
        //when we attempt to make the connection
    ...
    //cleaner method to clear comment when we move away from that activity
    clearComments = () => {
        this.comments = [];
